...
class DataProto:
    ...
    def select(self, batch_keys=None, non_tensor_batch_keys=None, meta_info_keys=None, deepcopy=False) -> "DataProto":
        ...
        if non_tensor_batch_keys is not None:
            ...
            if "multi_modal_inputs" in non_tensor_batch.keys() and len(non_tensor_batch["multi_modal_inputs"]) == 0:
                non_tensor_batch["multi_modal_inputs"] = non_tensor_batch["multi_modal_inputs"].data
        else:
