...
def tvg_zoom_compute_score(predict_str: str, ground_truth: str, gt_frame: list, video_length: float, response_str_zoom: str) -> float:
    ...
    if response_str_zoom in ground_truth or ground_truth in response_str_zoom:
        ...
        acc_reward_zoom = 0.0
    reward = (acc_reward + acc_reward_zoom + format_reward + tg_reward) / 4.0
    scores = {
        "iou": tg_reward,
        "answer": acc_reward,
