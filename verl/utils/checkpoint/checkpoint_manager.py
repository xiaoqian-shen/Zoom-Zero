...
def remove_obsolete_ckpt(
    path: str, global_step: int, best_global_steps: list[int], save_limit: int = -1, directory_format: str = "global_step_{}"
):
    """
